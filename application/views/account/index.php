    				...
    				<form class="col s12" action="<?php echo base_url();?>account/registration" method="post">
      				<div class="row">
                         	<div class="input-field col s12">
          					<input name="nama" id="nama" type="text" class="validate" value="<?php echo set_value('nama'); ?>">
        					...
        					<div class="input-field col s12">
                              ...
                              <div class="input-field col s12">
          					<input name="nomor_telepon" id="nomor_telepon" type="text" class="validate" value="<?php echo set_value('nomor_telepon'); ?>">
