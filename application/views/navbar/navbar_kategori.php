					...
					<a href="<?php echo base_url();?>home" class="brand-logo"><img src="<?php echo base_url();?>assets/img/logo_seve/logo2-01.png" style="margin-top:-0.2em; width:80px"></a>         
						...
						<ul id="slide-out" class="side-nav">
						      ...
						      <li class="no-padding">
						        <ul class="collapsible collapsible-accordion">
						          <li>
						            <a class="collapsible-header" style="text-transform: uppercase"><b><?php if(isset($category)) echo $category;?></b></a>
						            <div class="collapsible-body">
						              <ul>
					                	<?php foreach ($data->result() as $row){ ?>
					                	<li><a href="<?php echo base_url();?>categories/<?php echo $category;?>/<?php echo $row->pk_subcategory;?>" style="color:black"><?php echo $row->subcategory;?></a></li>
					                	<?php }?>
						              </ul>
						            </div>
						          </li>
